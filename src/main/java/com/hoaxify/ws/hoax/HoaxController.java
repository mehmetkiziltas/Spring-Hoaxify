...
public class HoaxController {
    ...
    @Autowired
    public HoaxController(final HoaxService hoaxService) {
        this.hoaxService = hoaxService;
    }

    @PostMapping("/hoaxes")
    GenericResponse saveHoax(@Valid @RequestBody HoaxSubmitVM hoax,
    ...
    ResponseEntity<?> getHoaxesRelative(@PageableDefault(sort = "id", direction = Sort.Direction.DESC)
                                                Pageable page,
